...
# Podfile README.md Yodo1MasSdk Yodo1MasSdkDemo Yodo1MasSdkDemo.xcodeproj Yodo1MasSdk_Deprecated build config.txt Think: What does it do? Why poddid you write it? What is the focus?
...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.8.8-alpha.1/iOS/Dev/Yodo1MasCore-4.8.8-alpha.1.zip' }
...
s.resources = 'Core/Assets/Yodo1MasCore.bundle', 'Core/Assets/Yodo1MasCore.plist'
