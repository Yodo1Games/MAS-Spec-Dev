...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.0-dev.3/iOS/Dev/Yodo1MasFull-4.14.0-dev.3.zip' }
...
s.dependency 'Yodo1MasCore', '4.14.0-dev.3'
s.dependency 'Yodo1MasMediationAdMob', '4.14.0-dev.3'
s.dependency 'Yodo1MasMediationApplovin', '4.14.0-dev.3'
s.dependency 'Yodo1MasMediationFyber', '4.14.0-dev.3'
s.dependency 'Yodo1MasMediationBidMachine', '4.14.0-dev.3'
s.dependency 'Yodo1MasMediationBigo', '4.14.0-dev.3'
s.dependency 'Yodo1MasMediationIronSource', '4.14.0-dev.3'
s.dependency 'Yodo1MasMediationFacebook', '4.14.0-dev.3'
s.dependency 'Yodo1MasMediationInMobi', '4.14.0-dev.3'
s.dependency 'Yodo1MasMediationMintegral', '4.14.0-dev.3'
s.dependency 'Yodo1MasMediationPangle', '4.14.0-dev.3'
s.dependency 'Yodo1MasMediationCSJ', '4.14.0-dev.3'
s.dependency 'Yodo1MasMediationTencent', '4.14.0-dev.3'
s.dependency 'Yodo1MasMediationToBid', '4.14.0-dev.3'
s.dependency 'Yodo1MasMediationUnityAds', '4.14.0-dev.3'
s.dependency 'Yodo1MasMediationVungle', '4.14.0-dev.3'
s.dependency 'Yodo1MasMediationYandex', '4.14.0-dev.3'
s.dependency 'Yodo1MasMediationYodo1', '4.14.0-dev.3'
end
