...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.4.5-dev-02/iOS/Dev/Yodo1MasFull-4.4.5-dev-02.zip' }
...
s.dependency 'Yodo1MasCore', '4.4.5-dev-02'
s.dependency 'Yodo1MasMediationAdMobMax', '4.4.5-dev-02'
s.dependency 'Yodo1MasMediationApplovinMax', '4.4.5-dev-02'
s.dependency 'Yodo1MasMediationFyberMax', '4.4.5-dev-02'
s.dependency 'Yodo1MasMediationIronSourceMax', '4.4.5-dev-02'

s.dependency 'Yodo1MasMediationAdColonyMax', '4.4.5-dev-02'
s.dependency 'Yodo1MasMediationFacebookMax', '4.4.5-dev-02'
s.dependency 'Yodo1MasMediationInMobiMax', '4.4.5-dev-02'
#s.dependency 'Yodo1MasMediationMintegralMax', '4.4.5-dev-02'
s.dependency 'Yodo1MasMediationMyTargetMax', '4.4.5-dev-02'
s.dependency 'Yodo1MasMediationPangleMax', '4.4.5-dev-02'
s.dependency 'Yodo1MasMediationTapjoyMax', '4.4.5-dev-02'
s.dependency 'Yodo1MasMediationTencentMax', '4.4.5-dev-02'
s.dependency 'Yodo1MasMediationUnityAdsMax', '4.4.5-dev-02'
s.dependency 'Yodo1MasMediationVungleMax', '4.4.5-dev-02'
s.dependency 'Yodo1MasMediationYandexMax', '4.4.5-dev-02'
s.dependency 'Yodo1MasMediationYodo1', '4.4.5-dev-02'
end
