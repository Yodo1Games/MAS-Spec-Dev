Pod::Spec.new do |s|
  ...
  DESC
  s.source = { :http => 'https://mas-artifacts.yodo1.com/5.0.0-dev.2/iOS/Dev/Yodo1MasMediationAdMob-5.0.0-dev.2.zip' }
  s.swift_version    = '5.0'
  ...
  s.subspec 'AppLovin' do |sub|
    sub.dependency 'Yodo1MasMediationAdMob/Core', '5.0.0-dev.2'
