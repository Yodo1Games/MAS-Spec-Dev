...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.0-dev.2/iOS/Dev/Yodo1MasMediationApplovin-4.14.0-dev.2.zip' }
...
sub.dependency 'Yodo1MasMediationApplovin/Amazon', '4.14.0-dev.2'
end
