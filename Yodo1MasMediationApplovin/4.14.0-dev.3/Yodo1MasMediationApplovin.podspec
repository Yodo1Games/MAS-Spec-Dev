...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.0-dev.3/iOS/Dev/Yodo1MasMediationApplovin-4.14.0-dev.3.zip' }
...
sub.dependency 'Yodo1MasMediationApplovin/Amazon', '4.14.0-dev.3'
end
