...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.0-dev.7/iOS/Dev/Yodo1MasMediationApplovin-4.14.0-dev.7.zip' }
...
sub.dependency 'Yodo1MasMediationApplovin/Amazon', '4.14.0-dev.7'
end
