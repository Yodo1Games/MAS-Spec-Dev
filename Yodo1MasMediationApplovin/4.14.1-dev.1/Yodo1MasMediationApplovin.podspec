...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.1-dev.1/iOS/Dev/Yodo1MasMediationApplovin-4.14.1-dev.1.zip' }
...
sub.dependency 'Yodo1MasCore', '4.14.1-dev.1'
sub.dependency 'AppLovinSDK', '12.6.1'

sub.dependency 'Yodo1MasMediationApplovin/Amazon', '4.14.1-dev.1'
end
s.subspec 'AdMob' do |sub|
# sub.resource = s.name + '/Assets/**/*'

sub.vendored_frameworks = "#{s.name}/#{s.name}.xcframework"
sub.dependency 'Yodo1MasMediationApplovin/Core', '4.14.1-dev.1'
