...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.2-dev.3/iOS/Dev/Yodo1MasMediationApplovin-4.14.2-dev.3.zip' }
s.swift_version = '5.0'
...
sub.vendored_frameworks = "#{s.name}/#{s.name}.xcframework"
sub.dependency 'Yodo1MasMediationApplovin/Core', '4.14.2-dev.3'
