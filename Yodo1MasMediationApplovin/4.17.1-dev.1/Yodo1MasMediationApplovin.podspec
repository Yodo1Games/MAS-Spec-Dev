...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.17.1-dev.1/iOS/Dev/Yodo1MasMediationApplovin-4.17.1-dev.1.zip' }
  s.swift_version    = '5.0'
...
sub.vendored_frameworks = "#{s.name}/#{s.name}.xcframework"
sub.dependency 'Yodo1MasMediationApplovin/Core', '4.17.1-dev.1'
