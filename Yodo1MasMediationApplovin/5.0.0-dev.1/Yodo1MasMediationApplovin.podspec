...
s.source = { :http => 'https://mas-artifacts.yodo1.com/5.0.0-dev.1/iOS/Dev/Yodo1MasMediationApplovin-5.0.0-dev.1.zip' }
  s.swift_version    = '5.0'
...
sub.dependency 'Yodo1MasMediationApplovin/Core', '5.0.0-dev.1'
...
sub.dependency 'Yodo1MasMediationApplovin/Core', '5.0.0-dev.1'
sub.dependency 'Yodo1MasMediationAurion11/A11Mediation', '5.0.0-dev.1'
sub.dependency 'Google-Mobile-Ads-SDK', '13.1.0'
