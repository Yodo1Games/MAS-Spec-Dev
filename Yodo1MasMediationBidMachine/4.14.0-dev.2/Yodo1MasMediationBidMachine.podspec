...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.0-dev.2/iOS/Dev/Yodo1MasMediationBidMachine-4.14.0-dev.2.zip' }
...
sub.dependency 'Yodo1MasCore', '4.14.0-dev.2'
sub.dependency 'BidMachine', '3.0.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationBidMachine/Core', '4.14.0-dev.2'
