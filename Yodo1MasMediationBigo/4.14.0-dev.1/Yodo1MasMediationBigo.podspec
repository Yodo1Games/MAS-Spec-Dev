...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.0-dev.1/iOS/Dev/Yodo1MasMediationBigo-4.14.0-dev.1.zip' }
...
sub.dependency 'BigoADS', '4.4.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationBigo/Core', '4.14.0-dev.1'
