...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.2-dev.4/iOS/Dev/Yodo1MasMediationFacebook-4.14.2-dev.4.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Yodo1MasMediationFacebook/Core', '4.14.2-dev.4'
