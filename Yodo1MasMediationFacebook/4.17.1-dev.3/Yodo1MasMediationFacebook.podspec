...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.17.1-dev.3/iOS/Dev/Yodo1MasMediationFacebook-4.17.1-dev.3.zip' }
  s.swift_version    = '5.0'
...
sub.dependency 'Yodo1MasMediationFacebook/Core', '4.17.1-dev.3'
