...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.2-dev.2/iOS/Dev/Yodo1MasMediationFyber-4.14.2-dev.2.zip' }
...
sub.dependency 'Yodo1MasCore', '4.14.2-dev.2'
sub.dependency 'Fyber_Marketplace_SDK', '8.3.3'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationFyber/Core', '4.14.2-dev.2'
...
sub.vendored_frameworks = "#{s.name}/#{s.name}.xcframework"
sub.dependency 'Yodo1MasMediationFyber/Core', '4.14.2-dev.2'
sub.dependency 'Google-Mobile-Ads-SDK', '11.12.0'
sub.vendored_frameworks = s.name + '/Lib/DTExchangeAdapter.xcframework'
end
# s.subspec 'IronSource' do |sub|
# sub.dependency, '4.14.2-dev.2'
# sub.dependency 'IronSourceSDK', '8.5.0.0'
