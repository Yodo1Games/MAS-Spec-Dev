...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.2-dev.3/iOS/Dev/Yodo1MasMediationFyber-4.14.2-dev.3.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Yodo1MasCore', '4.14.2-dev.3'
sub.dependency 'Fyber_Marketplace_SDK', '8.3.3'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationFyber/Core', '4.14.2-dev.3'
