...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.17.1-dev.1/iOS/Dev/Yodo1MasMediationFyber-4.17.1-dev.1.zip' }
  s.swift_version    = '5.0'
...
sub.dependency 'Yodo1MasMediationFyber/Core', '4.17.1-dev.1'
