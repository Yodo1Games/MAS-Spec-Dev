...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.0-dev.1/iOS/Dev/Yodo1MasMediationIronSource-4.14.0-dev.1.zip' }
...
sub.dependency 'Yodo1MasCore', '4.14.0-dev.1'
sub.dependency 'IronSourceSDK', '8.3.0.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationIronSource/Core', '4.14.0-dev.1'
