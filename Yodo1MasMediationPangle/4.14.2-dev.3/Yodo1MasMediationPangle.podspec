...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.2-dev.3/iOS/Dev/Yodo1MasMediationPangle-4.14.2-dev.3.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Ads-Global', '6.3.1.1'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationPangle/Core', '4.14.2-dev.3'
