...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.17.1-dev.2/iOS/Dev/Yodo1MasMediationTencent-4.17.1-dev.2.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Yodo1MasMediationTencent/Core', '4.17.1-dev.2'
