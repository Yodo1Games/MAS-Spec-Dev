...
s.source = { :http => 'https://mas-artifacts.yodo1.com/5.0.0-dev.1/iOS/Dev/Yodo1MasMediationUnityAds-5.0.0-dev.1.zip' }
  s.swift_version    = '5.0'
...
sub.dependency 'Yodo1MasMediationUnityAds/Core', '5.0.0-dev.1'
