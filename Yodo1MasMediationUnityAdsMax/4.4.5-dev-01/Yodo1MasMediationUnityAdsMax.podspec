...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.4.5-dev-01/iOS/Dev/Yodo1MasMediationUnityAdsMax-4.4.5-dev-01.zip' }
...
s.dependency 'Yodo1MasMediationUnityAds', '4.4.5-dev-01'
s.dependency 'Yodo1MasMediationAdMob', '4.4.5-dev-01'
s.dependency 'Yodo1MasMediationApplovin', '4.4.5-dev-01'
s.dependency 'Yodo1MasMediationIronSource', '4.4.5-dev-01'
end
