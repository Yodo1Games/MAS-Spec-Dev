Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://mas-artifacts.yodo1.com/5.0.0-dev.1/iOS/Dev/Yodo1MasMediationVungle-5.0.0-dev.1.zip' }
  s.swift_version    = '5.0'
  ...
  s.subspec 'AppLovin' do |sub|
    sub.dependency 'Yodo1MasMediationVungle/Core', '5.0.0-dev.1'
