...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.0-dev.1/iOS/Dev/Yodo1MasMediationYandex-4.14.0-dev.1.zip' }
...
sub.dependency 'YandexMobileAds', '7.4.0'
...
sub.dependency 'Yodo1MasMediationYandex/Core', '4.14.0-dev.1'
