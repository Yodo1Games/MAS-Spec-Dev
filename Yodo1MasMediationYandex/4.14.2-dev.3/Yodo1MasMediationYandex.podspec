...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.2-dev.3/iOS/Dev/Yodo1MasMediationYandex-4.14.2-dev.3.zip' }
s.swift_version = '5.7'
...
sub.dependency 'Yodo1MasMediationYandex/Core', '4.14.2-dev.3'
