Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://mas-artifacts.yodo1.com/5.0.0-dev.4/iOS/Dev/Yodo1MasMediationYso-5.0.0-dev.4.zip' }
  s.swift_version    = '5.0'
  ...
  s.subspec 'AppLovin' do |sub|
    sub.dependency 'Yodo1MasMediationYso/Core', '5.0.0-dev.4'
